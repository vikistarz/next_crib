...
import '../../../dialogs/successPasswordRecovery.dart';
import '../../../webService/apiConstant.dart';
class AgentResetPasswordPage extends StatefulWidget {
  const AgentResetPasswordPage({super.key});

  @override
  State<AgentResetPasswordPage> createState() => _AgentResetPasswordPageState();
}

class _AgentResetPasswordPageState extends State<AgentResetPasswordPage> {
  ...
  Future<void> makePostRequest() async {
    loading();
    const String apiUrl = ApiConstant.agentResetPassword;
    print('PATCH: $apiUrl');
    try {
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text("Enter a different password with the previous",style: TextStyle(color: HexColor("#9CA3AF"), fontWeight: FontWeight.normal, fontSize:14.0,),),
            ),
