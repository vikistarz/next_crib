...
import 'package:next_crib/screens/logIn/ui/agent/agentResetPassword.dart';
...
class AgentValidateOtpPage extends StatefulWidget {
  const AgentValidateOtpPage({super.key});

  @override
  State<AgentValidateOtpPage> createState() => _AgentValidateOtpPageState();
}

class _AgentValidateOtpPageState extends State<AgentValidateOtpPage> {
  ...
  Future<void> makePostRequest() async {
    loading();
    const String apiUrl = ApiConstant.agentValidateOtp;
    print('post: $apiUrl');
    try {
