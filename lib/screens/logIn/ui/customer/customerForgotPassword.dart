...
import 'package:next_crib/screens/logIn/ui/customer/customerValidateOtp.dart';
...
class _CustomerForgotPasswordPageState extends State<CustomerForgotPasswordPage> {
  ...
  Future<void> makePostRequest() async {
    loading();
    const String apiUrl = ApiConstant.customerForgetPassword;
    print('post: $apiUrl');
    try {
                ...
                return SuccessMessageDialog(
                  ...
                  onButtonPressed: () {
                    ...
                    Navigator.push(context, MaterialPageRoute(builder: (context){
                      return CustomerValidateOtpPage();
                    }));
                    saveUserDetails();
                  },
                );
