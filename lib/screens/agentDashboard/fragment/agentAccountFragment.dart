...
import 'package:next_crib/screens/agentDashboard/ui/editAgentprofile.dart';
...
class AgentAccountFragment extends StatefulWidget {
  ...
  @override
  State<AgentAccountFragment> createState() => _AgentAccountFragmentState();
}

class _AgentAccountFragmentState extends State<AgentAccountFragment> {
                      ...
                      Padding(
                        padding: const EdgeInsets.only(right: 20.0, top: 25.0),
                          child: CircleAvatar(
                            ...
                            // child: Text("EV", style: TextStyle(color: Colors.white, fontSize: 42.0, fontWeight: FontWeight.bold),),
                          ),
                      ),
                    ],
                  ),
