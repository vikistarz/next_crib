...
class _CityDialogState extends State<CityDialog> {
  ...
  List<CityResponseModel> _items = [];
  List<CityResponseModel> _filteredItems = [];



  Future<List<CityResponseModel>> fetchCity() async {
    loading();
    SaveValues mySaveValues = SaveValues();
    String? state_code = await mySaveValues.getString(AppPreferenceHelper.SELECTED_STATE_CODE);

    final String apiUrl = ApiConstant.baseUri + 'location/cities/NG/$state_code';
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text("Select City", style: TextStyle(fontSize: 18.0,fontWeight: FontWeight.bold, color: Colors.black),
            ),
          ),
